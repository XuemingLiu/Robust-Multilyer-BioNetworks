# calculate the influence scores in the multilayer netowrks including the general GRN
# Output: final functional sizes in the PPI network after removing each gene
...
PPI_Nodes_Robust[,2] <- sort(PPIFunc_NonIso) 
    ...
    write.table(PPI_Nodes_Robust, "SingleAttack_PPI_Robust_GRN.txt",row.names = FALSE, col.names = FALSE)      
